    ...
    return async function (createFFmpegCore = {}) {
        ...
        var PThread = {
            ...
            allocateUnusedWorker: function () {
                var worker;
                if (!Module['locateFile']) {
                    worker = new Worker(new URL('ffmpeg-core.worker.js', import.meta.url));
                } else {
        ...
        var __emscripten_tls_init = (Module['__emscripten_tls_init'] = function () {
            return (__emscripten_tls_init = Module['__emscripten_tls_init'] = Module['asm']['Na']).apply(
                null,
                arguments,
            );
        });
        ...
        var __emscripten_thread_init = (Module['__emscripten_thread_init'] = function () {
            return (__emscripten_thread_init = Module['__emscripten_thread_init'] = Module['asm']['Qa']).apply(
                null,
                arguments,
            );
        });
        var __emscripten_thread_crashed = (Module['__emscripten_thread_crashed'] = function () {
            return (__emscripten_thread_crashed = Module['__emscripten_thread_crashed'] = Module['asm']['Ra']).apply(
                null,
                arguments,
            );
        });
        ...
        var __emscripten_thread_exit = (Module['__emscripten_thread_exit'] = function () {
            return (__emscripten_thread_exit = Module['__emscripten_thread_exit'] = Module['asm']['Va']).apply(
                null,
                arguments,
            );
        });
        var __emscripten_check_mailbox = (Module['__emscripten_check_mailbox'] = function () {
            return (__emscripten_check_mailbox = Module['__emscripten_check_mailbox'] = Module['asm']['Wa']).apply(
                null,
                arguments,
            );
        });
